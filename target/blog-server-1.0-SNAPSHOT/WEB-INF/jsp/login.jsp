        ...
        <main>
            ...
            <form action="/handlelogin" method="post">
                ...
                <div class="form-item bottom">
                    <div class="form-btn" type="submit">登陆</div>
                </div>
                <c:if test="${msg != null}">
                    <div style="color: #FF6666; text-align: center; margin-top: 15px;">${msg}</div>
                </c:if>
            </form>
        </main>
    </section>
    ...
    <script>
        $(function () {
            ...
            $('[type="submit"]').on('click', function (){
                var flag= $('form').serializeArray().every(item => item.value.trim().length)
               if (flag) {
                   $('form').submit()
               } else {
                   alert("信息请输入全")
